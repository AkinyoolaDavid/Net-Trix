      ...
      <section className="container flex h-[650px] flex-col items-center justify-center md:h-[500px] ">
        <div className="grid grid-cols-1 items-center gap-8 dark:text-white md:grid-cols-2">
          ...
          >
            ...
            Net Trix Solutions Inc. : Where Insight Meet Tech And Innovations.
            </h1>
            <p className="">
            Unlocking limitless opportunities of innovations and explorations to create a unified experience in North-America.
            </p>
